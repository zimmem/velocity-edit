...
public class Plugin extends AbstractUIPlugin {
	...
	public static final String PLUGIN_ID = "velocityweb"; //$NON-NLS-1$
	...
	public ImageDescriptor getImageDescriptor(String key) {
		URL url = null;
		try {
			url = new URL(plugin.getBundle().getEntry("/"), "icons/" + key);
	...
	public static void log(String message, boolean error) {
		if (devMode) {
			...
			try {
				String logFileName = FileLocator.resolve(plugin.getBundle().getEntry("/")).getFile() + "error.log";
