 ...
 */
public class VelocityOverlayPreferenceStore implements IPreferenceStore
{
    ...
    public VelocityOverlayPreferenceStore(IPreferenceStore parent, OverlayKey[] overlayKeys)
    {
        fParent = parent;
