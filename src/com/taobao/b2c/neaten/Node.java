...
/**
 * @author xiaoxie
 * @create time£º2008-5-8 ÏÂÎç02:11:43
 * @description
 */
public interface Node {
	...
	public static String FORMAT_TYPE_OPEN_FIRST_LINE = "5";//Õë¶Ôif  else  forµÈ
	...
	//public static String FULL_TAG_NODE = "full_tag_node";
...
//	void setBlockParentNode(Node node);
//	
//	Node getBlockParentNode();
